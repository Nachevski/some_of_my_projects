...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['search'])) {
    ...
    $searchResults = search($keyword, 'categories');
                    ...
                    <div class="car mr-20 h-100 w-100">
                        <div class="dashboardCards h-100 d-flex flex-column">
                            <div class="dashboard-card d-flex justiify-content-between align-items-center">
                                ...
                                <h3 id="totalCommentsCounter"><?= count($categories) ?></h3>
                            </div>
                                ...
                                <div class="results text-left">
                                    ...
                                    if ($searchStatus && !empty($searchResults)) {
                                        echo "<p class='m-0'>Showing results for: " . $keyword . "</p>
                                              <p>Search returned: " . count($categories) . " categories</p>";
                            ...
                            <div class="d-flex border-default border-radius-15 p-20 mb-10 flex-column">
                                <div class="newAuthor mb-20 self-end">
                                    <button id="BTN-NewCategory" class=" btn btn-approve">Add New Category</button>
                                </div>
                                <div class="flex-100">
                                    <div class="table">
                                        <table class="table w-100 text-left">
                                            ...
                                            <?php foreach ($categories as $index => $category) : ?>
                                                <tr class="inputRow" id="author<?= $index ?>"
                                                    ...
                                                    <td class="firstName"><?= $category->getCategoryName() ?></td>
                                                    <td class="totalBooks"><?= count(getBooksByCategory($books, $category->getCategoryID())) ?></td>
                                                    <td>
                                                        <div class="actions d-flex">
                                                            <div class="btn btn-edit mr-10 BTN-ModifyCategory"
                                                                 data-id="<?= $category->getCategoryID() ?>">
                                                                Modify
                                                            </div>

                                                            <form action="Processing/deleteCategory.php" method="POST"
                                                                  class="mr-10">
                                                                <input type="text"
                                                                       value="<?= $category->getCategoryID() ?>"
                                                                       name="categoryID" hidden="">
                                                                <button class="BTN-DeleteCategory btn btn-danger"
                                                                        type="submit">Delete
                                                                </button>
                                                            </form>
                                                        </div>
...
<div id="editWindow" class="pos-fixed abs-full d-flex align-items-center justify-content-center hide">
    <div class="ModalWindowForm p-15">
        <h2 class="text-center">Modify Category Name</h2>
        <div class="d-flex">
            <form action="./Processing/editCategory.php" method="POST" id="modifyCategoryForm"
                  class="flex-50 d-flex flex-column justiify-content-between">
                <div class="form-container">

                    <div class="form-group d-flex flex-column">
                        <label for="categoryName">Catygory Name</label>
                        <input type="text" class="categoryName" name="categoryName" value="">
                    </div>

                    <input id="categoryID" type="text" name="categoryID" value="" hidden>
                </div>
...
<div id="newCategoryWindow" class="pos-fixed abs-full d-flex align-items-center justify-content-center hide">
    <div class="ModalWindowForm p-15">
        <h2 class="text-center">Add New Book Category</h2>
        <div class="d-flex">
            <form action="./Processing/addNewCategory.php" method="POST" id="newCategoryForm"
                  class="flex-50  d-flex flex-column justiify-content-between">
                <div class="form-container">
                    <div class="form-group d-flex flex-column">
                ...
                <div class="form-group d-flex justify-content-center">
                    <button id="BTN-SaveCategory" type="submit" class="btn btn-approve mr-20">Save Changes</button>
                    <div class="btn btn-danger btnCancel">Cancel</div>
                </div>
            </form>
        </div>
